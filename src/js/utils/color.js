...
/**
 * Is the given color considered "dark" (closer to black than white)?
 * @param {string} color Hex or RGB(A) color  
 * @param {Number} cutoff Numeric value for darkness threshold, 0 (black) to 255 (white) 
 * @returns true if dark, false if light
 */
export function IsDark(color, cutoff = 127.5) {
